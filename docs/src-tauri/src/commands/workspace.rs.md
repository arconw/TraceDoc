...
- `open_workspace(app,session,watcher,rootPath)` — blocking scan/canonicalization, session activation, generation-bound native watcher start, then revisioned refresh snapshot.
